        ...
        <div className="py-24 bg-white dark:bg-brand-dark">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <AnimatedSection className="text-center">
                    <h1 className="font-poppins text-5xl md:text-6xl font-extrabold text-gray-900 dark:text-white">Our Training <span className="text-brand-red">Programs</span></h1>
                    <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-600 dark:text-gray-400">Engineered for discipline, designed for results. Find the program that will unlock your potential.</p>
                </AnimatedSection>
                
                {loading && <div className="text-center text-gray-500 dark:text-gray-400 mt-20 text-xl">Loading Programs...</div>}
                    ...
                    <>
                                ...
                                <AnimatedSection key={program.id}>
                                    <div className={`flex flex-col md:flex-row items-center gap-12 ${index % 2 !== 0 ? 'md:flex-row-reverse' : ''}`}>
                                        <div className="md:w-1/2">
                                            <div className="border border-gray-200 dark:border-gray-800 p-10 rounded-lg bg-gray-50 dark:bg-black/30 transition-all duration-300 hover:shadow-2xl hover:shadow-brand-red/10 hover:border-brand-red/50">
                                                <h2 className="font-poppins text-4xl font-bold text-brand-red">{program.title}</h2>
                                                <p className="text-lg text-gray-700 dark:text-gray-300 mt-2">{program.subtitle}</p>
                                                <p className="mt-6 text-gray-600 dark:text-gray-400">{program.description}</p>
                                                ...
                                                <div className="mt-10 flex items-center justify-between">
                                                    <p className="text-3xl font-poppins font-bold text-gray-900 dark:text-white">{program.price}</p>
                        ...
                        <AnimatedSection className="mt-32">
                            <div className="text-center">
                                 <h2 className="font-poppins text-4xl md:text-5xl font-bold text-gray-900 dark:text-white">Frequently Asked <span className="text-brand-red">Questions</span></h2>
                                 <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-600 dark:text-gray-400">Your questions, answered. If you don't see your question here, feel free to contact us.</p>
                            </div>
